all_models = ["LinearModel", "KNN", "DecisionTree", "RandomForest", "XGBoost", "CatBoost", "LightGBM", "ModelTree",
               ...
               "SAINT", "DANet"] + ["mlp", "resnet", "transformer"]
...
# rtdl models
        ...
        from models.mlp_rtdl import MLP
        return MLP
    
    elif model == "resnet":
        from models.resnet_rtdl import ResNet
        return ResNet
    
    elif model == "transformer":
        from models.transformer_rtdl2 import Transformer
        return Transformer
